...
function MainDev() {
    return (
        <Container className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
            ...
            <p>You may ask, "but why Blockchain?" Different experiences lead me to look for an alternative to the system I was brought up in. I was no longer convinced
                ...
                <Link to="/Developper/Why Blockchain.js">(Read more..)</Link>
            </p>
            <Navbar />
        </Container>
    )
