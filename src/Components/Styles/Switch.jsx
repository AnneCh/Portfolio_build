...
export const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  width: 62,
  height: 34,
  padding: '10px 8px 8px 8px',  // combined padding
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === 'dark' ? '#c2a5c9' : '#e0b9eb',
      },
  ...
  '& .MuiSwitch-thumb': {
    backgroundColor: theme.palette.mode === 'dark' ? '#8c75d9' : '#170652',
    width: 32,
    height: 32,
  ...
  '& .MuiSwitch-track': {
    ...
    borderRadius: 10,  // Simplified to half of 20
  },
  '&[class*="Mui-checked"]': {
    transform: 'translateX(22px)', // This ensures that it's always 22px, regardless of any other class
  },
}));
